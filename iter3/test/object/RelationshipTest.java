...
public class RelationshipTest {
	Class temp = new Class(0, 0);
	Class temp2 = new Class(200, 0);
	Class temp3 = new Class(150, 200);
	Class temp4 = new Class(400, 200);
	Class temp5 = new Class(400, 400);
	Class temp6 = new Class(600, 400);

	Aggregation a = new Aggregation(new Class(0, 0), new Class(200, 0));
	Association as = new Association(new Class(200, 200), new Class(400, 200));
	Composition c = new Composition(new Class(400, 400), new Class(600, 400));
	Dependency d = new Dependency(new Class(600, 600), new Class(800, 600));
	Generalization g = new Generalization(new Class(0, 600), new Class(300, 600));
	...
	public void testSetLocation() {
		a.setLocation();
		a.setClass1(new Class(0, 200));
		a.setClass2(new Class(200, 190));
		a.setLocation();
		a.setClass1(new Class(100, 200));
		a.setClass2(new Class(200, 0));
		a.setLocation();
		a.setClass1(new Class(100, 0));
		a.setClass2(new Class(200, 200));
		a.setLocation();
		a.setClass1(new Class(200, 200));
		a.setClass2(new Class(0, 0));
		a.setLocation();
		a.setClass1(new Class(200, 0));
		a.setClass2(new Class(0, 200));
		a.setLocation();
		a.setClass1(new Class(200, 200));
		a.setClass2(new Class(100, 0));
		a.setLocation();
		a.setClass1(new Class(200, 0));
		a.setClass2(new Class(100, 200));
		a.setLocation();
		a.setClass1(temp);
		a.setClass2(temp2);

		as.setLocation();
		as.setClass1(new Class(0, 200));
		as.setClass2(new Class(200, 190));
		as.setLocation();
		as.setClass1(new Class(100, 200));
		as.setClass2(new Class(200, 0));
		as.setLocation();
		as.setClass1(new Class(100, 0));
		as.setClass2(new Class(200, 200));
		as.setLocation();
		as.setClass1(new Class(200, 200));
		as.setClass2(new Class(0, 0));
		as.setLocation();
		as.setClass1(new Class(200, 0));
		as.setClass2(new Class(0, 200));
		as.setLocation();
		as.setClass1(new Class(200, 200));
		as.setClass2(new Class(100, 0));
		as.setLocation();
		as.setClass1(new Class(200, 0));
		as.setClass2(new Class(100, 200));
		as.setLocation();
		as.setClass1(temp2);
		as.setClass2(temp3);

		c.setLocation();
		c.setClass1(new Class(0, 200));
		c.setClass2(new Class(200, 190));
		c.setLocation();
		c.setClass1(new Class(100, 200));
		c.setClass2(new Class(200, 0));
		c.setLocation();
		c.setClass1(new Class(100, 0));
		c.setClass2(new Class(200, 200));
		c.setLocation();
		c.setClass1(new Class(200, 200));
		c.setClass2(new Class(0, 0));
		c.setLocation();
		c.setClass1(new Class(200, 0));
		c.setClass2(new Class(0, 200));
		c.setLocation();
		c.setClass1(new Class(200, 200));
		c.setClass2(new Class(100, 0));
		c.setLocation();
		c.setClass1(new Class(200, 0));
		c.setClass2(new Class(100, 200));
		c.setLocation();
		c.setClass1(temp3);
		c.setClass2(temp4);

		d.setLocation();
		d.setClass1(new Class(0, 200));
		d.setClass2(new Class(200, 190));
		d.setLocation();
		d.setClass1(new Class(100, 200));
		d.setClass2(new Class(200, 0));
		d.setLocation();
		d.setClass1(new Class(100, 0));
		d.setClass2(new Class(200, 200));
		d.setLocation();
		d.setClass1(new Class(200, 200));
		d.setClass2(new Class(0, 0));
		d.setLocation();
		d.setClass1(new Class(200, 0));
		d.setClass2(new Class(0, 200));
		d.setLocation();
		d.setClass1(new Class(200, 200));
		d.setClass2(new Class(100, 0));
		d.setLocation();
		d.setClass1(new Class(200, 0));
		d.setClass2(new Class(100, 200));
		d.setLocation();
		d.setClass1(temp4);
		d.setClass2(temp5);

		g.setLocation();
		g.setClass1(new Class(0, 200));
		g.setClass2(new Class(200, 190));
		g.setLocation();
		g.setClass1(new Class(100, 200));
		g.setClass2(new Class(200, 0));
		g.setLocation();
		g.setClass1(new Class(100, 0));
		g.setClass2(new Class(200, 200));
		g.setLocation();
		g.setClass1(new Class(200, 200));
		g.setClass2(new Class(0, 0));
		g.setLocation();
		g.setClass1(new Class(200, 0));
		g.setClass2(new Class(0, 200));
		g.setLocation();
		g.setClass1(new Class(200, 200));
		g.setClass2(new Class(100, 0));
		g.setLocation();
		g.setClass1(new Class(200, 0));
		g.setClass2(new Class(100, 200));
		g.setLocation();
		g.setClass1(temp5);
		g.setClass2(temp6);
